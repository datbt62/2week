...
var SnowFlake = function(expireCallback) {
    ...
    var $element = $('<div class="snowflake" style="z-index:1500;position: fixed; color:#fff; text-shadow: rgba(0, 0, 0, 0.7) 1px 1px 2px;background: #fff; width: 5px;height:5px;border-radius: 50%"></div>');
